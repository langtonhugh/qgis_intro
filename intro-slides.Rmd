...
- You have likely used some form of GIS before.
- It is an entire field and community.
- Used in academic research, government, charities, military and private sectors.
...
- Spatial data simply represent the real world.
- Describes the location, size and shape of entities.
- Quantified for use in GIS.
...
- This inherently introduces distortion.
